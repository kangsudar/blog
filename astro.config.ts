...
export default defineConfig({
  ...
  redirects: {
    // v1.0.0 -> v3.0.0
    '/2025/06/review-hostinger-indonesia.html':
      '/blog/review-hostinger',
    '/2025/06/dewaweb-cloud-hosting-terbaik.html':
      '/blog/review-dewaweb',
    '/2025/06/review-mendalam-layanan-rumahweb-solusi.html':
      '/blog/review-rumahweb',
